...
unet_path = "unet_sd1-5_UNet2DConditionModel" #"completion_sd1-5_4"
...
OUT_MODEL_PATH = "completion_sd1-5_res_1"
...
class RGBCompletionDataset(Dataset):
    ...
    def __getitem__(
        ...
        # Goal Change: Generating only the occluded portion instead of the whole unoccluded image
        resedue_rgb = unoccluded_rgb - occluded_rgb
        unoccluded_rgb = resedue_rgb
